  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (responseData.data && responseData.data.status === true) {
        ...
        localStorage.setItem('hremail', JSON.stringify(responseData.data.userDetails.email));
        if (responseData.data.userDetails.role === 'hr') {
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-pink-600 to-pink-800 
        ...
        <div className="z-10 text-white text-center w-full mt-4">
          ...
          <p className="text-1xl mb-6">
            <i>Connecting talent, fostering growth, and simplifying HR processes seamlessly.</i>
          </p>
        </div>
      </div>
