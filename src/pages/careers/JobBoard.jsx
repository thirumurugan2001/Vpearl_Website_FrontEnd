...
const JobBoard = () => {
  ...
  const handleApply = (jobId, title) => {
    navigate("/candidateRegistrationForm", {
      state: { jobId: jobId, title: title },
    });
    window.scrollTo(0, 0);
  };
          ...
          <div className="bg-gradient-to-r from-pink-900 via-pink-600 to-pink-900 rounded-xl shadow-lg overflow-hidden mb-6">
            <div className="relative px-4 py-8 sm:px-8 sm:py-12">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-base text-pink-100 max-w-2xl mx-auto cinzel-body">
                  Ready for your next opportunity? Check out our top job
                  listings now!
                </p>
              </div>
            </div>
          ...
          {error && (
            <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-lg shadow-md">
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-lg font-medium text-red-800 cinzel-heading">
                    Error Loading Jobs
                  </h3>
            ...
            <>
              ...
              <div className="bg-white p-4 rounded-lg shadow">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-lg font-medium cinzel-heading">
                    Filters
                  </h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1 cinzel-heading">
                      Department
                    </label>
                    <select
              ...
              <div className="bg-white rounded-lg shadow overflow-hidden">
                <div className="p-4 border-b">
                  <h2 className="text-lg font-extralight cinzel-heading">
                ...
                {jobs.length === 0 ? (
                  <div className="text-center p-12 bg-white rounded-xl">
                    ...
                    <h3 className="mt-4 text-lg font-medium text-gray-900 cinzel-heading">
                      No Jobs Available
                    </h3>
                    <p className="mt-2 text-gray-500 cinzel-body">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
                    {filteredJobs.map((job) => (
                      ...
                      >
                        <h3 className="font-medium text-lg mb-2 cinzel-heading">
                          {job.title}
                        </h3>
              ...
              {activeJob && filteredJobs.length > 0 && (
                <div className="bg-white rounded-lg shadow p-6">
                  <div className="border-b pb-4 mb-4">
                    <h2 className="text-2xl font-extrabold cinzel-heading">
                      {activeJob.title}
                    </h2>
                  ...
                  <div className="space-y-6">
                    <div>
                      <h3 className="text-lg font-extrabold mb-2 cinzel-heading">
                        Description
                      </h3>
                      <p className="text-gray-600 cinzel-body">
                    ...
                    <div className="pt-4">
                      <button
                        onClick={() =>
                          handleApply(activeJob.id, activeJob.title)
                        }
                      >
